...
public class HMM {
    ...
    public void read_inputs(Scanner sc) {
        int l=0;
        while(sc.hasNext()){
            A = matrixOps.read_matrix(sc.nextLine());
            if(l==0){
            states = A.length;
            
            }else if(l==1){
                B = matrixOps.read_matrix(sc.nextLine());
                emissions = B[0].length;
               
            }else if(l==2)     
            pi = matrixOps.read_matrix(sc.nextLine());       
    ...
    public void next_emission() {
        ...
        //System.out.println("e ="+emission_prob);
